				...
				<table class="table">
					...
					<tbody>
						...
						<tr>
							...
							<td><img src="../uploads/product/<?= $row['foto'] ?>" width="80"></td>
							...
							<td align="center"> 
								...
								<a href="?delete=<?= $row['idproduk'] ?>" class="btn"  onclick="return confirm('yakin ga hayo?yakin dong')" title="Hapus Data"><i class="fa fa-times"></i></a>
							</td>
						</tr>
						<?php }}else{ ?>
