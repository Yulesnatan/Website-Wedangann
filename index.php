...
<head>
	...
	<title>Home - wedanganpembalap</title>
	...
	<style type="text/css">
		...
		* {
		...
		.banner {
			...
			background-image:url('assets/img/Angkringan.jfif');
...
<body>
	...
	!-- sidebar -->
	<div class="sidebar sidebar-hide sidebar">
			...
			<div class="row">
				...
				<div class="col-6">
					...
					<a href="detail.php?id=<?= $row['idproduk'] ?>">
						<div class="card-menu">
							<img src="uploads/product/<?= $row['foto']?>">
							<div class="card-body">
